...
교실 내부 LAN 전용 실시간 채팅 웹 애플리케이션입니다. 공개 채팅, 접속자 목록, 1:1 DM을 지원합니다.
...
- 앱 내부에서도 원본 메시지를 2 KiB로 제한하고 채팅 내용은 500자로 제한합니다.
...
전체 IP와 공개 메시지는 호스트의 `data/chat.db`에 저장되고 10시간 뒤 삭제됩니다. DM 내용은 데이터베이스에 저장하지 않습니다. IP는 수업 중 문제 사용을 조사하기 위한 단서일 뿐 확정적인 신원 증명은 아닙니다.
